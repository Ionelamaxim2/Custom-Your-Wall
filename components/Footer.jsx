...
const tape = (
  <svg
    ...
    fill="none"
  >
    <path d="M1 45L70.282 5L88.282 36.1769L19 76.1769L1 45Z" fill="#a8d8ff" />
    <path
...
const SocialIcon = ({ href, label, rotation = 0 }) => {
  ...
  const IconComponent = label === "Instagram" ? Instagram : Facebook;
  const iconImageUrl =
    label === "Instagram"
  ...
  return (
    <div
      className="relative cursor-pointer transition-opacity duration-200 py-2"
    ...
    >
      {hovered && (
        <div
          className="absolute -top-10 left-1/2 transform -translate-x-1/2 flex items-center justify-center z-50"
          style={{ animation }}
        >
          <img
            src={iconImageUrl}
...
export default function Footer() {
  ...
  return (
    <footer
      className="w-full pt-12 pb-0 px-4"
      ...
      <div className="relative bg-white rounded-3xl max-w-6xl mx-auto px-6 md:px-12 py-12 pb-16 flex flex-col items-start gap-8 mb-0">
        ...
        <div className="block md:hidden w-full px-2">
          ...
          <div className="text-center mb-6">
            <Link
              href="/"
              className="inline-block text-3xl font-bold text-black"
            >
              {t.footerTitle}
            </Link>
          </div>
          {/* Two columns: Resources and Legal */}
          <div className="grid grid-cols-2 gap-6 mb-6">
            <div className="flex flex-col items-center gap-2">
              <h4 className="uppercase text-sm text-gray-900 font-semibold text-center">
                {t.resources}
              </h4>
              <div className="flex flex-col gap-2 text-sm text-black items-center text-center">
                <Link
          ...
          <div className="flex items-center justify-center gap-6">
            <SocialIcon
              href="https://www.instagram.com/customyourwall.ig/"
              label="Instagram"
              rotation={0}
            />
            <SocialIcon
              href="https://www.facebook.com/profile.php?id=61583014917048"
              label="Facebook"
              rotation={0}
            />
          </div>
        ...
        {/* Desktop layout */}
        <div className="hidden md:flex flex-col md:flex-row items-start justify-between gap-4 md:gap-10 px-2 md:px-8 w-full">
          {/* Brand Section */}
          <div className="flex flex-col items-start gap-2">
            <Link
              href="/"
              className="flex flex-row gap-1 items-center justify-start text-3xl md:text-4xl font-bold text-black"
            >
              {t.footerTitle}
            </Link>
            <p className="text-gray-600 font-medium text-base w-full md:w-4/5 mb-8">
              {t.footerSubtitle}
            </p>
          ...
          <div className="flex flex-col md:mx-4 md:flex-row gap-8 md:gap-16 items-start md:items-start">
            <div className="flex flex-col gap-1 md:gap-4">
              ...
              <div className="flex flex-wrap md:flex-col gap-2 text-sm text-black items-start">
                <Link
                  className="text-gray-600 whitespace-nowrap font-medium hover:text-black transition"
                  href="/gallery"
                >
                  {t.gallery}
                </Link>
            ...
            <div className="flex flex-col gap-1 md:gap-4">
              <h4 className="uppercase whitespace-nowrap text-sm text-gray-500 font-semibold">
                {t.legal}
              </h4>
              <div className="flex flex-col gap-2 text-sm text-black items-start">
                <Link
                  className="text-gray-600 whitespace-nowrap font-medium hover:text-black transition"
                  href="/about"
                >
        ...
        {/* Copyright at bottom center - at the very bottom */}
